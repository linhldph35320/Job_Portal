                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    ...
                                    <option value="10_plus"
                                        {{ Request::get('experience') == '10_plus' ? 'selected' : '' }}>10+ Years</option>
                                </select>
                            </div>
                        ...
                        <div class="job_lists">
                            <div class="row">
                                @if ($jobs->isNotEmpty())
                                    ...
                                    @endforeach
                                    <div class="col-md-12">
                                        {{-- khi tìm kiếm sẽ quay về trang đầu và khi ấn sang trang tiếp theo đường link sẽ vẫn đc giữ --}}
...
@section('customJs')
    <script>
        $("#searchForm").submit(function(e) {
            ...
            // Khi keyword có dữ liệu
            if (keyword != "") {
                url += '&keyword=' + keyword;
            }

            // Khi location có dữ liệu
            if (location != "") {
                url += '&location=' + location;
            }

            // Khi category có dữ liệu
            if (category != "") {
                url += '&category=' + category;
            }

            // Khi experience có dữ liệu
            if (experience != "") {
                url += '&experience=' + experience;
            }


            // Khi jobType được chọn
