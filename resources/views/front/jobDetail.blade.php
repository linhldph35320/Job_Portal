        ...
        <div class="container job_details_area">
            <div class="row pb-5">
                <div class="col-md-8">
                    ...
                    {{-- Hiển thị những người đã apply khi bạn đăng nhập bằng account nhà tuyển dụng --}}
                    @if (Auth::user())
                            ...
                            <div class="card shadow border-0 mt-4">
                                ...
                                <div class="descript_wrap white-bg">
                                    <table class="table table-striped">
                                        ...
                                        @else
                                        <tr>
                                            <td colspan="3">Applicans not found</td>
                                        </tr>
                                        @endif
                                    </table>
                                </div>
                    ...
                    <div class="card shadow border-0">
                        <div class="job_sumary">
                            ...
                            <div class="job_content pt-3">
                                <ul>
                                    <li>Published on:
                                        <span>{{ \Carbon\Carbon::parse($job->create_at)->format('d M, Y') }}</span>
                                    </li>
